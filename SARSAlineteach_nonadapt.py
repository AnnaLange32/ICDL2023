...
def generate_reward(train_images, current_state, current_action, img_c, img_f):
    ...
    rsize: tuple
    preferred size of the individual picture
...
def update_q_non_adapt(train_images, start_location, start_img, max_iter,  q, cumulative_reward, cumulative_energy, total_reward, total_energy, no_of_state_visits, total_energy_by_state, total_reward_by_state, td_storage, helper_reward, i, condition, help_requests, interaction_stops, interaction_restart):
    ...
    while current_iter < max_iter:
        ...
        if help == 1:
           ...
           # if moving_average_helper < constants.mov_avr_tresh and joint_counter > 3 :
            #    print('####AGENT IS IGNORING PARTNER###')
        ...
        if r_current < 0 :#and i < help_stop_iter
         ...
         #   print('####AGENT IS RECONSIDERING PARTNER###')
